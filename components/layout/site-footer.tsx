  ...
  return (
    <footer className="border-t bg-slate-50">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 sm:grid-cols-2 sm:px-6 lg:grid-cols-4">
        <div>
          <p className="font-display text-lg font-semibold text-[#021d33]">MedScopeGlobal</p>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link href="/categories" className="hover:text-foreground">Odborné obory</Link></li>
            <li><Link href="/medicina" className="hover:text-foreground">Medicína</Link></li>
          </ul>
        </div>
        <div>
