...
export function DokumentaceTutorial({
  ...
  return (
    <section
      ...
      aria-label="Ukázka MedScope Dokumentace"
    >
      {variant === "full" ? (
        <div
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch">
            ...
            <div className="overflow-hidden rounded-[1.75rem] border border-[#0a4a78]/40 bg-[#021d33] shadow-2xl">
              <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
                <div>
                  ...
                  <p className="text-sm font-semibold text-white">Dokumentace</p>
                </div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-3 text-[11px] leading-4 text-slate-500">
              Přístup a stažení jen pro ověřené lékaře · účet MedScope synchronizuje historii.
            </p>
          </div>
        </div>
      </div>
