...
async function check() {
  ...
  const checks = {
    uiVersion: health.uiVersion === "v23.2.3",
    logoAssets: home.text.includes("/assets/logo/"),
    logoWebp: home.text.includes(".webp") || home.text.includes("/assets/logo/"),
    headerTaglineRemoved: !home.text.includes("text-[10px] uppercase tracking-[0.2em]"),
    newsletterOk: posledni.status === 200 && posledni.text.includes("/assets/logo/"),
    adminLoginOk: adminLogin.status === 200,
