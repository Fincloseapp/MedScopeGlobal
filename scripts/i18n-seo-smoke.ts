...
assert.equal(getRevenueCopy("cs").newsletterCta.includes("Přihlásit"), true);
assert.equal(getRevenueCopy("fr").newsletterCta.includes("inscrire") || getRevenueCopy("fr").newsletterCta.includes("S’inscrire") || getRevenueCopy("fr").newsletterCta.includes("S'inscrire"), true);
assert.ok(!looksLikeCzech(getRevenueCopy("fr").partnerTitle));
assert.ok(!looksLikeCzech(getRevenueCopy("de").subscribeTitle));
assert.ok(!looksLikeCzech(getRevenueCopy("en").newsletterBody));
