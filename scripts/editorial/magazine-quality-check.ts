...
assert.equal(isPlaceholderUniversityNewsTitle("Výzkumné objevy na Lékařské fakultě Masarykovy univerzity"), true);
assert.equal(isPlaceholderUniversityNewsTitle("Nový výzkum na Lékařské fakultě Masarykovy univerzity"), true);
