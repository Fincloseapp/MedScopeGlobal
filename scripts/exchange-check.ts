...
assert.ok(readFileSync(join(root, "components/exchange/homepage-billboard.tsx"), "utf8").includes("from-[#021d33]"));
assert.ok(!readFileSync(join(root, "components/exchange/homepage-billboard.tsx"), "utf8").includes("rounded-3xl bg-white"));
assert.ok(readFileSync(join(root, "components/exchange/marketplace-hero.tsx"), "utf8").includes("from-[#021d33]"));
assert.ok(!readFileSync(join(root, "components/exchange/marketplace-hero.tsx"), "utf8").includes("rounded-3xl bg-white"));
