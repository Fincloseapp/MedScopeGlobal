...
const CASES: SmokeCase[] = [
  { path: "/", label: "root locale redirect", expectStatus: [302, 307, 308], allowRedirect: true },
  {
    ...
    expectStatus: 200,
    expectBody: /href="\/article\/|Zpravodajství|ViaLongeVita/i,
  },
  ...
  { path: "/de/articles", label: "German articles listing", expectStatus: 200 },
  {
    ...
    expectStatus: 200,
    expectBody: /href="\/article\/[^"]+|ViaLongeVita/i,
  },
  {
    path: "/cs/article/verejnost-zivotni-styl-zdravy-spanek",
    label: "Demo seed article detail",
    expectStatus: 200,
    expectBody: /spánek|ViaLongeVita|Příspěvek|Podpořit autora|Přispět/i,
  },
  {
  ...
  {
    path: "/cs/vitascope",
    label: "Legacy VitaScope alias → home",
    expectStatus: 200,
    expectBody: /ViaLongeVita/i,
  },
  {
    path: "/cs/vialongevita",
    label: "ViaLongeVita brand alias → home",
    expectStatus: 200,
    expectBody: /ViaLongeVita/i,
  },
  {
    ...
    expectStatus: 200,
    expectBody: /article|ViaLongeVita|Zpravodajství/i,
  },
  {
    path: "/cs/tips",
    label: "Tips alias → articles (not VIP)",
    expectStatus: 200,
    expectBody: /článk|articles|ViaLongeVita|magazín|Zpravodajství/i,
  },
  {
    path: "/cs/affiliate",
