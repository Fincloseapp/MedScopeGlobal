...
const pages = [
  { path: "/", must: ["MeDipacient", "MeDiprep", "MeDiktor", "Zpravodajství", "medscopeglobal.com", "svátek", "/mediktor"], mustNot: ["denní crony"] },
  ...
  { path: "/mediktor/ceny", must: ["MeDiktor", "390", "Solo", "Stripe"] },
