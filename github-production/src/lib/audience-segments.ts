export const audienceSegments = [
  {
    ...
    articleFilter: "/articles?audience=laik-student",
    ctaHref: "/medicina/priprava",
    ctaLabel: "Příprava na medicínu",
    profileCta: "Vstoupit jako student"
  },
  {
    slug: "lekar",
    title: "Lékař v praxi",
    ...
    articleFilter: "/articles?audience=clinician",
    ctaHref: "/portal/articles",
    ctaLabel: "Odborný portál",
    profileCta: "Obsah pro praxi"
  },
  {
    slug: "vedec",
    ...
    profileCta: "Research monitoring"
  }
] as const;
