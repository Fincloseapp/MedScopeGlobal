...
const staticRoutes: MetadataRoute.Sitemap = [
  ...
  { url: `${base}/aplikace`, changeFrequency: "weekly", priority: 0.95 },
  { url: `${base}/medipacient`, changeFrequency: "weekly", priority: 0.9 },
  { url: `${base}/medipacient/stahnout`, changeFrequency: "monthly", priority: 0.8 },
  { url: `${base}/app/pacient`, changeFrequency: "weekly", priority: 0.9 },
  { url: `${base}/mediprep`, changeFrequency: "weekly", priority: 0.9 },
  { url: `${base}/mediprep/stahnout`, changeFrequency: "monthly", priority: 0.8 },
  { url: `${base}/app/priprava`, changeFrequency: "weekly", priority: 0.9 },
  { url: `${base}/lekari/dokumentace`, changeFrequency: "weekly", priority: 0.9 },
  { url: `${base}/app/dokumentace`, changeFrequency: "weekly", priority: 0.85 },
  { url: `${base}/dashboard`, changeFrequency: "weekly", priority: 0.8 },
  { url: `${base}/predplatne`, changeFrequency: "weekly", priority: 0.95 },
  { url: `${base}/verejnost`, changeFrequency: "daily", priority: 0.85 },
  { url: `${base}/studenti`, changeFrequency: "weekly", priority: 0.85 },
  { url: `${base}/lekari`, changeFrequency: "weekly", priority: 0.85 },
