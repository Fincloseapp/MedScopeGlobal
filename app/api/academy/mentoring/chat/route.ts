...
function buildFallbackReply(input: ChatBody): string {
  ...
  return `K tématu „${topic}": doporučuji projít si klíčové pojmy v textu lekce a ověřit znalosti v kvízu. Pro detailní vysvětlení nastavte LLM API klíč (OpenAI/Anthropic) v prostředí MedScope Academy.`;
}
