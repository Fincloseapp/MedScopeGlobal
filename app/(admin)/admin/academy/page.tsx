...
import { ExpertReviewCronBadge, VideoProviderBadge } from "@/components/academy/admin-pipeline-badges";
  ...
  return (
    <>
      <p className="text-sm text-slate-600">
        Přehled Academy v35 — fáze 13 (simulace, učebnice, certifikáty, expert review cron).
      </p>

      <div className="mt-4 space-y-3">
        <DigestDeliveryBadge />
        <VideoProviderBadge />
        <ExpertReviewCronBadge />
        <AdminDigestTestSend />
        <div
