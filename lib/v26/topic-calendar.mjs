...
export const CURRENT_EVENT_SEEDS = [
  ...
  { seed: "RSV, covid a chřipka vedle sebe", angle: "příznaky, očkování, kdy zůstat doma" },
  ...
  { seed: "Screen time a spánek dětí před školou", angle: "limity, rodinná pravidla" },
  { seed: "Klíšťata, teplo a pozdní léto", angle: "ochrana v přírodě bez paniky" },
  { seed: "Kvalita ovzduší, pyl a dušnost", angle: "praktické kroky pro citlivé skupiny" },
  { seed: "Preventivní screening rakoviny — aktualizace doporučení", angle: "věk, frekvence, dostupnost v ČR" },
  { seed: "Osamělost a zdraví po 50", angle: "vztahy jako faktor dlouhověkosti" },
  { seed: "Bílkoviny, síla a sarkopenie", angle: "česká kuchyně bez prášků a extrémů" },
];
