...
export const SITE = {
  ...
  tagline: "VitaScope · MeDipacient · MeDiprep · OrdiZapis",
  description:
    "VitaScope — globální magazín zdraví a dlouhověkosti na MedScopeGlobal.com. MediFlow, VIP protokoly, MeDipacient, MeDiprep a OrdiZapis. Evidence-based obsah ve 19 jazycích. 14 dní zdarma.",
