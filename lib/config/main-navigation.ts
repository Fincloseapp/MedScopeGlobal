...
const menuCs: NavItem[] = [
  {
    ...
    children: [
      ...
      { label: "MeDiktor", href: "/lekari/mediktor", description: "AI zápisy pro ověřené lékaře" },
...
const menuEn: NavItem[] = [
  {
    ...
    children: [
      ...
      { label: "MeDiktor", href: "/lekari/mediktor", description: "AI notes for verified physicians" },
  ...
  return [
    ...
    lekari ? { ...lekari, label: "Lékaři" } : { label: "Lékaři", href: "/lekari" },
    {
      ...
      children: [
        ...
        { label: "MeDiktor", href: "/lekari/mediktor", description: "AI zápisy pro lékaře" },
