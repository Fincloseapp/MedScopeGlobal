...
const menuCs: NavItem[] = [
  ...
  { label: "Kariéra", href: "/kariera" },
  {
    ...
    children: [
      ...
      { label: "Paušál tržiště", href: "/inzerce/pausal", description: "Od 4 900 Kč / měsíc, karta Stripe" },
...
function firmyNav(): NavItem {
  return {
    ...
    children: [
      ...
      { label: "Paušál tržiště", href: "/inzerce/pausal", description: "Od 4 900 Kč / měsíc, karta nebo převod" },
