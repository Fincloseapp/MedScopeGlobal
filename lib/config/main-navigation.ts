...
const menuCs: NavItem[] = [
  ...
  { label: "Kariéra", href: "/kariera" },
  {
    ...
    children: [
      ...
      { label: "Tržiště", href: "/exchange", description: "Nabídky, poptávky, paušál — ne magazín" },
      { label: "Paušál tržiště", href: "/inzerce/pausal", description: "Od 450 Kč / měsíc, roční 2 měsíce zdarma" },
      { label: "Inzerce v magazínu", href: "/inzerce", description: "Bannery u čtenářů — jiný produkt" },
      { label: "Ceník inzerce", href: "/inzerce/cenik", description: "Bannery a balíčky magazínu" },
      { label: "Objednávka reklamy", href: "/inzerce/formular", description: "Jednorázová kampaň v magazínu" },
...
function firmyNav(): NavItem {
  return {
    ...
    children: [
      ...
      { label: "Paušál tržiště", href: "/inzerce/pausal", description: "Od 450 Kč / měsíc, karta nebo převod" },
      ...
      { label: "Poptávka magazínu", href: "/inzerce/formular", description: "Jednorázový banner — jiný produkt" },
    ],
  };
}
