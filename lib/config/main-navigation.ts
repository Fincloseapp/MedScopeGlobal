...
const menuCs: NavItem[] = [
  {
    ...
    children: [
      ...
      { label: "MeDiktor", href: "/mediktor", description: "AI zápisy pro ověřené lékaře" },
      { label: "Ceník MeDiktor", href: "/mediktor/ceny", description: "390 Kč/měsíc · ambulance · nemocnice" },
      { label: "Otevřít MeDiktor", href: "/app/mediktor", description: "Nahrávat v mobilu" },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/mediktor/ceny",
        description: "Tarify pro lékaře, ambulance a nemocnice",
      },
      {
...
const menuEn: NavItem[] = [
  {
    ...
    children: [
      ...
      { label: "MeDiktor", href: "/mediktor", description: "AI notes for verified physicians" },
      { label: "MeDiktor pricing", href: "/mediktor/ceny", description: "390 CZK/mo · clinics · hospitals" },
      { label: "Open MeDiktor", href: "/app/mediktor", description: "Record on mobile" },
  ...
  return [
    ...
    lekari ? { ...lekari, label: "Lékaři" } : { label: "Lékaři", href: "/lekari" },
    {
      ...
      children: [
        ...
        { label: "MeDiktor", href: "/mediktor", description: "AI zápisy pro lékaře" },
        { label: "Ceník MeDiktor", href: "/mediktor/ceny", description: "390 Kč · ambulance · nemocnice" },
        { label: "Stáhnout MeDiktor", href: "/app/mediktor", description: "Nahrávání v mobilu" },
