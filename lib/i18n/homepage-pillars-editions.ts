  ...
  ro: {
    ...
    pillars: {
      ...
      marketplace: {
        ...
        cta: "Comandă forfaitul",
        secondary: "Deschide piața",
      },
      students: {
  ...
  hu: {
    ...
    pillars: {
      ...
      marketplace: {
        ...
        cta: "Átalány megrendelése",
        secondary: "Piactér megnyitása",
      },
      students: {
