...
const COPY: Record<ChromePack, ShareCopy> = {
  cs: {
    ...
    clipsLead: "Tři univerzální reklamy — healthspan, spánek, životní styl. Na záběru ViaLongeVita a medscopeglobal.com. Ne odborná lekce.",
  ...
  de: {
    ...
    clipsLead: "Drei universelle Spots — Healthspan, Schlaf, Alltag. ViaLongeVita und medscopeglobal.com im Bild. Keine Fachlektion.",
  ...
  fr: {
    ...
    clipsLead: "Trois spots universels — healthspan, sommeil, quotidien. ViaLongeVita et medscopeglobal.com à l’image. Pas une leçon.",
  ...
  en: {
    ...
    clipsLead: "Three universal ads — healthspan, sleep, living. ViaLongeVita and medscopeglobal.com on screen. Not a lesson.",
  ...
  it: {
    ...
    clipsLead: "Tre spot universali — healthspan, sonno, quotidiano. ViaLongeVita e medscopeglobal.com in quadro. Non una lezione.",
  ...
  es: {
    ...
    clipsLead: "Tres spots universales — healthspan, sueño, vida. ViaLongeVita y medscopeglobal.com en pantalla. No es una lección.",
  ...
  "pt-BR": {
    ...
    clipsLead: "Três spots universais — healthspan, sono, vida. ViaLongeVita e medscopeglobal.com no ecrã. Não é uma lição.",
