...
const CS: MarketingCopy = {
  ...
  students: {
    ...
    lead: "Jedna přehledná mapa: kvízy, odbornost, fakulty a žebříček přezdívek. Pět kol zdarma — pak klub za 149 Kč/měsíc, zrušíte kdykoli.",
    priceLine: "5 kol kvízu zdarma · 14 dní trial · 149 Kč/měsíc · zrušíte kdykoli",
    ...
    parentsBody:
      "Předplatné Student LF (od 149 Kč/měsíc) otevírá celou Academy a AI tutor. Nezaručuje přijetí na medicínu — zvyšuje ale šanci tím, že dítě má strukturovanou přípravu, kvízy a zpětnou vazbu. Začněte trialem.",
    parentBullets: [
      "První lekce kurzů zdarma — bez karty",
      "14 dní plného přístupu zdarma",
      "Cena srovnatelná s jedním doučováním",
      "Obsah v češtině, zaměřený na LF přijímačky",
    ],
    giftTrial: "Darovat / vyzkoušet 14 dní",
    showPrep: "Ukázat dítěti přípravu",
    subTitle: "Studentské předplatné — od 149 Kč/měsíc",
    subLead:
    ...
    subBenefits: [
      ...
      "14 dní zdarma, pak od 149 Kč/měsíc (Student LF)",
    ],
    ...
    applicantSteps: [
      ...
      { title: "14 dní zdarma", body: "Celá Academy + AI tutor bez závazku.", cta: "Vyzkoušet předplatné" },
    ],
    lfSteps: [
...
const EN: MarketingCopy = {
  ...
  students: {
    ...
    metaDescription:
      "Faculty admissions prep, study materials and quizzes. Student plan from 149 CZK/month — first lesson and trial free.",
    ...
    priceLine: "First lesson free · 14-day trial · from 149 CZK/month",
    ...
    parentsBody:
      "The Student LF plan (from 149 CZK/month) opens Academy and the AI tutor. It does not guarantee admission — it gives structured prep, quizzes and feedback. Start with the trial.",
    parentBullets: [
      "First course lessons free — no card",
      "14 days of full access free",
      "Priced like a single tutoring session",
      "Content in Czech, aimed at faculty admissions",
    ],
    giftTrial: "Gift / try 14 days",
    showPrep: "Show the student the prep",
    subTitle: "Student plan — from 149 CZK/month",
    ...
    subBenefits: [
      ...
      "14 days free, then from 149 CZK/month (Student LF)",
    ],
    ...
    applicantSteps: [
      ...
      { title: "14 days free", body: "Full Academy + AI tutor with no commitment.", cta: "Try the plan" },
    ],
    lfSteps: [
...
const DE: MarketingCopy = {
  ...
  students: {
    ...
    metaDescription:
      "Vorbereitung auf die Aufnahmeprüfung, Lernmaterial und Quiz. Studententarif ab 149 CZK/Monat — erste Lektion und Testphase kostenlos.",
...
const FR: MarketingCopy = {
  ...
  students: {
    ...
    metaDescription:
      "Prépa concours, supports et quiz. Formule étudiant dès 149 CZK/mois — première leçon et essai gratuits.",
