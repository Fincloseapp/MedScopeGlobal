...
const CS: MarketingCopy = {
  ...
  students: {
    ...
    lead: "Jedna přehledná mapa pro uchazeče, studenty LF i rodiče: přijímačky, materiály, testy. Začněte zdarma — bez bloudění a bez prázdných slibů.",
    priceLine: "První lekce zdarma · 14 dní trial · od 149 Kč/měsíc",
