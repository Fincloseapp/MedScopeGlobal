...
const CS: MarketingCopy = {
  ...
  publicHub: {
    ...
    featuredTitle: "Pohyb, jóga, spánek a kosmetika",
    steps: [
      {
      ...
      },
      {
        ...
        desc: "Redakční články bez odborného žargonu. Denní video tip s kvízem.",
        cta: "Zobrazit články",
      },
      {
    ...
    quick: [
      ...
      { href: "/verejnost/clanky?topic=pohyb", label: "Pohyb a cvičení", desc: "Síla, chůze a regenerace — redakčně" },
      { href: "/verejnost/clanky?topic=joga", label: "Jóga", desc: "Mobilita a dech — bez ezoteriky" },
      { href: "/verejnost/clanky?topic=kosmetika", label: "Kosmetika a pleť", desc: "Dermokosmetika a fotoprotekce" },
    ...
    topics: {
      ...
      pohyb: { label: "Pohyb a cvičení", description: "Síla, chůze a regenerace — redakční texty, ne trénink na míru." },
      joga: { label: "Jóga", description: "Mobilita a dech — bez ezoteriky a zázračných slibů." },
      kosmetika: { label: "Kosmetika a pleť", description: "Dermokosmetika a fotoprotekce na úrovni důkazů." },
    },
  },
  students: {
...
const EN: MarketingCopy = {
  ...
  publicHub: {
    ...
    featuredTitle: "Movement, yoga, sleep and skincare",
    steps: [
    ...
    quick: [
      ...
      { href: "/verejnost/clanky?topic=pohyb", label: "Movement and exercise", desc: "Strength, walking and recovery — editorial" },
      { href: "/verejnost/clanky?topic=joga", label: "Yoga", desc: "Mobility and breath — no esoterics" },
      { href: "/verejnost/clanky?topic=kosmetika", label: "Skincare", desc: "Dermocosmetics and photoprotection" },
    ...
    topics: {
      ...
      pohyb: { label: "Movement and exercise", description: "Strength, walking and recovery — editorial, not a personal training plan." },
      joga: { label: "Yoga", description: "Mobility and breath — no esoterics, no miracle claims." },
      kosmetika: { label: "Skincare", description: "Dermocosmetics and photoprotection at evidence level." },
    },
  },
  students: {
...
const DE: MarketingCopy = {
  ...
  publicHub: {
    ...
    featuredTitle: "Bewegung, Yoga, Schlaf und Hautpflege",
    quick: [
      ...
      { href: "/verejnost/clanky?topic=dlouhovekost", label: "Langlebigkeit", desc: "Healthspan, Schlaf, Bewegung und Biomarker" },
      { href: "/verejnost/clanky?topic=pohyb", label: "Bewegung und Training", desc: "Kraft, Gehen und Regeneration — redaktionell" },
      { href: "/verejnost/clanky?topic=joga", label: "Yoga", desc: "Mobilität und Atem — ohne Esoterik" },
      { href: "/verejnost/clanky?topic=kosmetika", label: "Hautpflege", desc: "Dermokosmetik und Lichtschutz" },
      { href: "/verejnost/osveta", label: "Heutiger Gesundheitstipp", desc: "Kurzes Video mit Avatar und Quiz" },
      { href: "/ai-asistent/verejnost", label: "KI fragen", desc: "Antworten zur Prävention — kein Ersatz für den Arzt" },
      { href: "/verejnost/rozhovory", label: "Gespräche mit Fachleuten", desc: "Ärztinnen und Spezialisten erklären verständlich" },
      { href: "/verejnost/zebricek", label: "XP-Rangliste", desc: "Punkte für Tipps und Quiz" },
    ],
    steps: [
      { title: "Thema finden", desc: "Bereiche durchsehen — Prävention, Ernährung, Schlaf und mehr.", cta: "Themen durchsehen" },
      { title: "Artikel oder Tipp lesen", desc: "Redaktionelle Texte ohne Fachjargon. Ein täglicher Videotipp mit Quiz.", cta: "Artikel zeigen" },
    ...
    topics: {
      ...
      pohyb: { label: "Bewegung und Training", description: "Kraft, Gehen und Regeneration — redaktionell, kein Personal Training." },
      joga: { label: "Yoga", description: "Mobilität und Atem — ohne Esoterik und Wunderversprechen." },
      kosmetika: { label: "Hautpflege", description: "Dermokosmetik und Lichtschutz auf Evidenzniveau." },
    },
  },
  students: {
    ...EN.students,
...
const FR: MarketingCopy = {
  ...
  publicHub: {
    ...
    featuredTitle: "Mouvement, yoga, sommeil et soin de la peau",
    quick: [
      ...
      { href: "/verejnost/clanky?topic=dlouhovekost", label: "Longévité", desc: "Healthspan, sommeil, mouvement et biomarqueurs" },
      { href: "/verejnost/clanky?topic=pohyb", label: "Mouvement et exercice", desc: "Force, marche et récupération — éditorial" },
      { href: "/verejnost/clanky?topic=joga", label: "Yoga", desc: "Mobilité et souffle — sans ésotérisme" },
      { href: "/verejnost/clanky?topic=kosmetika", label: "Soin de la peau", desc: "Dermocosmétique et photoprotection" },
      { href: "/verejnost/osveta", label: "Conseil santé du jour", desc: "Une courte vidéo avec avatar et quiz" },
      { href: "/ai-asistent/verejnost", label: "Demander à l’IA", desc: "Réponses sur la prévention — ne remplacent pas un médecin" },
      { href: "/verejnost/rozhovory", label: "Entretiens avec des experts", desc: "Les cliniciens expliquent en langage clair" },
      { href: "/verejnost/zebricek", label: "Classement XP", desc: "Points pour les conseils et les quiz" },
    ],
    steps: [
      { title: "Trouver un sujet", desc: "Parcourir les domaines — prévention, nutrition, sommeil et plus.", cta: "Parcourir les sujets" },
      { title: "Lire un article ou un conseil", desc: "Textes rédactionnels, sans jargon. Un conseil vidéo du jour avec quiz.", cta: "Voir les articles" },
    ...
    topics: {
      ...
      pohyb: { label: "Mouvement et exercice", description: "Force, marche et récupération — éditorial, pas un plan d’entraînement." },
      joga: { label: "Yoga", description: "Mobilité et souffle — sans ésotérisme ni promesses miracles." },
      kosmetika: { label: "Soin de la peau", description: "Dermocosmétique et photoprotection au niveau des preuves." },
    },
  },
  students: {
    ...EN.students,
