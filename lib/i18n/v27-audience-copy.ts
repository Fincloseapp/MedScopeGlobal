...
const PHYSICIAN: Record<ChromePack, HubOverlay> = {
  ...
  de: {
    ...
    description: "OrdiZapis, Leitlinien mit DOI und Studienkurzberichte. CME nur bei akkreditierter Rheumatologie.",
    ctaPrimary: "Fachbereich",
    ctaSecondary: "Dokumentation",
    enter: "Öffnen",
    topics: ["OrdiZapis", "Leitlinien", "DOI", "Studien"],
  },
  fr: {
    label: "Pour les médecins",
    shortLabel: "Médecins",
    description: "OrdiZapis, guidelines avec DOI et synthèses d’études. FMC uniquement en rhumatologie accréditée.",
    ctaPrimary: "Espace pro",
    ctaSecondary: "Documentation",
    enter: "Entrer",
    topics: ["OrdiZapis", "guidelines", "DOI", "études"],
  },
  it: {
    label: "Per i medici",
    shortLabel: "Medici",
    description: "OrdiZapis, linee guida con DOI e sintesi di studi. ECM solo in reumatologia accreditata.",
  ...
  es: {
    label: "Para médicos",
    shortLabel: "Médicos",
    description: "OrdiZapis, guías con DOI y síntesis de estudios. FMC solo en reumatología acreditada.",
    ctaPrimary: "Área profesional",
    ctaSecondary: "Documentación",
    enter: "Entrar",
    topics: ["OrdiZapis", "guías", "DOI", "estudios"],
  },
  "pt-BR": {
    label: "Para médicos",
    shortLabel: "Médicos",
    description: "OrdiZapis, guidelines com DOI e sínteses de estudos. Educação continuada só em reumatologia acreditada.",
    ctaPrimary: "Área profissional",
    ctaSecondary: "Documentação",
    enter: "Entrar",
    topics: ["OrdiZapis", "guidelines", "DOI", "estudos"],
  },
  en: {
    label: "For physicians",
    shortLabel: "Physicians",
    description: "OrdiZapis, cited guidelines with DOI, and study briefs. CME only for accredited rheumatology.",
    ctaPrimary: "Professional desk",
    ctaSecondary: "Documentation",
    enter: "Enter",
    topics: ["OrdiZapis", "guidelines", "DOI", "studies"],
  },
};
