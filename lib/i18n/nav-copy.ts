...
const NAV: Record<string, NavStrings> = {
  en: {
    ...
    "/mediprep": { label: "MeDiprep", description: "Czech medical-school admissions prep" },
    ...
    "/verejnost/clanky": { label: "Editorial articles", description: "Editorial pieces without jargon" },
    "/verejnost/clanky?topic=dlouhovekost": {
      label: "Longevity",
      description: "Healthspan, sleep, movement and food — read free",
    },
    "/verejnost/clanky?topic=pohyb": {
      label: "Movement and exercise",
      description: "Strength, walking and recovery",
    },
    "/verejnost/clanky?topic=joga": {
      label: "Yoga",
      description: "Mobility and breath — no esoterics",
    },
    "/verejnost/clanky?topic=kosmetika": {
      label: "Skincare",
      description: "Dermocosmetics and photoprotection",
    },
    ...
    "/predplatne": { label: "Subscribe", description: "Editorial billed now · OrdiZapis 14 days" },
    ...
    "/predplatne#physician": { label: "Physician plan", description: "OrdiZapis and DOI guidelines" },
    ...
    "/lekari": { label: "Physicians", description: "OrdiZapis, DOI guidelines, rheumatology CME" },
    ...
    "/lekari/research-hub": { label: "DOI guidelines", description: "ESC hypertension, ACS, atrial fibrillation" },
    ...
    "/odborne/briefy": { label: "Clinical briefs", description: "Structured medical notes" },
    "/leky": { label: "Medicines", description: "SÚKL, EMA, approved products" },
    "/articles": { label: "Magazine", description: "News, public health and longevity" },
    "/articles/archiv": { label: "Archive", description: "Older articles and briefs" },
    "/hledat": { label: "Search", description: "Search the magazine archive" },
    ...
    "/firmy": { label: "Companies", description: "Banners and partnerships in the magazine" },
    "/exchange": { label: "Manufacturer marketplace", description: "Czechia and the EU — CE / IVDR, not the magazine" },
    ...
    "/firmy/kosmetika": { label: "Beauty brands", description: "Premium dermocosmetics in the public desk" },
  ...
  de: {
    ...
    "/mediprep": { label: "MeDiprep", description: "Tschechische Medizineraufnahme" },
    ...
    "/verejnost/clanky": { label: "Redaktionsartikel", description: "Redaktionelle Texte ohne Fachjargon" },
    "/verejnost/clanky?topic=dlouhovekost": {
      label: "Langlebigkeit",
      description: "Healthspan, Schlaf, Bewegung und Essen — frei lesbar",
    },
    "/verejnost/clanky?topic=pohyb": {
      label: "Bewegung und Training",
      description: "Kraft, Gehen und Regeneration",
    },
    "/verejnost/clanky?topic=joga": {
      label: "Yoga",
      description: "Mobilität und Atem — ohne Esoterik",
    },
    "/verejnost/clanky?topic=kosmetika": {
      label: "Hautpflege",
      description: "Dermokosmetik und Lichtschutz",
    },
    ...
    "/predplatne": { label: "Abo", description: "Redaktion sofort · OrdiZapis 14 Tage" },
    "/predplatne#student": { label: "Studententarif", description: "1 Test frei · 6 €, danach 10 €" },
    ...
    "/predplatne#physician": { label: "Arzt in der Praxis", description: "OrdiZapis und DOI-Leitlinien" },
    ...
    "/lekari": { label: "Ärzte", description: "OrdiZapis und DOI-Leitlinien" },
    ...
    "/lekari/research-hub": { label: "DOI-Leitlinien", description: "ESC Hypertonie, ACS, Vorhofflimmern" },
    ...
    "/odborne/briefy": { label: "Fach-Briefs", description: "Strukturierte medizinische Kurzberichte" },
    "/leky": { label: "Arzneimittel", description: "SÚKL, EMA, zugelassene Präparate" },
    "/articles": { label: "Magazin", description: "News, öffentliche Gesundheit und Langlebigkeit" },
    "/articles/archiv": { label: "Archiv", description: "Ältere Artikel und Briefs" },
    "/hledat": { label: "Suche", description: "Suche im Magazinarchiv" },
    ...
    "/firmy": { label: "Unternehmen", description: "Banner und Partnerschaften im Magazin" },
    "/exchange": { label: "Herstellermarktplatz", description: "Tschechien und die EU — CE / IVDR, nicht das Magazin" },
    ...
    "/firmy/kampane": { label: "Kampagnen", description: "Segmentierung Magazin / Öffentlichkeit" },
    "/firmy/kosmetika": { label: "Kosmetikmarken", description: "Premium-Dermokosmetik in der öffentlichen Rubrik" },
    "/inzerce/formular": { label: "Anfrage", description: "Angebot innerhalb von 2 Arbeitstagen" },
  ...
  fr: {
    ...
    "/mediprep": { label: "MeDiprep", description: "Concours des facultés tchèques" },
    ...
    "/verejnost/clanky": { label: "Articles de la rédaction", description: "Textes de rédaction, sans jargon" },
    "/verejnost/clanky?topic=dlouhovekost": {
      label: "Longévité",
      description: "Healthspan, sommeil, mouvement et alimentation — lecture libre",
    },
    "/verejnost/clanky?topic=pohyb": {
      label: "Mouvement et exercice",
      description: "Force, marche et récupération",
    },
    "/verejnost/clanky?topic=joga": {
      label: "Yoga",
      description: "Mobilité et souffle — sans ésotérisme",
    },
    "/verejnost/clanky?topic=kosmetika": {
      label: "Soin de la peau",
      description: "Dermocosmétique et photoprotection",
    },
    ...
    "/predplatne": { label: "Abonnement", description: "Rédaction tout de suite · OrdiZapis 14 jours" },
    "/predplatne#student": { label: "Formule étudiant", description: "1 test offert · 6 €, puis 10 €" },
    ...
    "/predplatne#physician": { label: "Médecin en exercice", description: "OrdiZapis et recommandations DOI" },
    ...
    "/lekari": { label: "Médecins", description: "OrdiZapis, recommandations DOI, FMC rhumatologie" },
    ...
    "/lekari/research-hub": { label: "Recommandations DOI", description: "ESC hypertension, SCA, fibrillation" },
    ...
    "/odborne/briefy": { label: "Briefs cliniques", description: "Notes médicales structurées" },
    "/leky": { label: "Médicaments", description: "SÚKL, EMA, produits autorisés" },
    "/articles": { label: "Magazine", description: "Actualités, santé publique et longévité" },
    "/articles/archiv": { label: "Archives", description: "Anciens articles et briefs" },
    "/hledat": { label: "Recherche", description: "Recherche dans les archives du magazine" },
    ...
    "/kontakt": { label: "Contact" },
    "/firmy": { label: "Entreprises", description: "Bannières et partenariats dans le magazine" },
    "/exchange": { label: "Place de marché fabricants", description: "Tchéquie et UE — CE / IVDR, pas le magazine" },
    ...
    "/firmy/kampane": { label: "Campagnes", description: "Segmentation magazine / grand public" },
    "/firmy/kosmetika": { label: "Marques de cosmétique", description: "Dermocosmétique premium dans l’espace public" },
    "/inzerce/formular": { label: "Demande", description: "Offre sous 2 jours ouvrés" },
  ...
  pt: {
    ...
    "/verejnost/clanky?topic=pohyb": { label: "Movimento e exercício", description: "Força, marcha e recuperação" },
    "/verejnost/clanky?topic=joga": { label: "Ioga", description: "Mobilidade e respiração" },
    "/verejnost/clanky?topic=kosmetika": { label: "Cuidado da pele", description: "Dermocosmética e fotoproteção" },
    ...
    "/exchange": { label: "Mercado de fabricantes", description: "Chéquia e UE — CE / IVDR, não a revista" },
  },
  "pt-BR": {
    "/aplikace": { label: "Apps", description: "MediFlow, MeDipacient, OrdiZapis" },
    "/mediflow": { label: "MediFlow", description: "Diário de bem-estar e longevidade" },
    ...
    "/verejnost/clanky?topic=pohyb": { label: "Movimento e exercício", description: "Força, caminhada e recuperação" },
    "/verejnost/clanky?topic=joga": { label: "Ioga", description: "Mobilidade e respiração" },
    "/verejnost/clanky?topic=kosmetika": { label: "Cuidado da pele", description: "Dermocosmética e fotoproteção" },
    "/verejnost/osveta": { label: "Dica de hoje", description: "Um gesto prático para hoje" },
    "/verejnost/rozhovory": { label: "Conversas", description: "Clínicos em linguagem clara" },
  ...
  it: {
    ...
    "/verejnost/clanky?topic=pohyb": { label: "Movimento e esercizio", description: "Forza, camminata e recupero" },
    "/verejnost/clanky?topic=joga": { label: "Yoga", description: "Mobilità e respiro" },
    "/verejnost/clanky?topic=kosmetika": { label: "Cura della pelle", description: "Dermocosmesi e fotoprotezione" },
    ...
    "/lekari": { label: "Medici", description: "OrdiZapis, linee guida DOI, ECM reumatologia" },
    ...
    "/exchange": { label: "Mercato produttori", description: "Cechia e UE — CE / IVDR, non il magazine" },
  ...
  es: {
    ...
    "/verejnost/clanky?topic=pohyb": { label: "Movimiento y ejercicio", description: "Fuerza, marcha y recuperación" },
    "/verejnost/clanky?topic=joga": { label: "Yoga", description: "Movilidad y respiración" },
    "/verejnost/clanky?topic=kosmetika": { label: "Cuidado de la piel", description: "Dermocosmética y fotoprotección" },
    ...
    "/lekari": { label: "Médicos", description: "OrdiZapis, guías DOI, FMC reumatología" },
    ...
    "/exchange": { label: "Mercado de fabricantes", description: "Chequia y la UE — CE / IVDR, no la revista" },
