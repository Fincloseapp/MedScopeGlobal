...
const NAV: Record<string, NavStrings> = {
  en: {
    ...
    "/exchange": { label: "B2B Exchange", description: "Healthcare marketplace — direct contact, no intro fee" },
    ...
    "/exchange/pricing": { label: "Exchange pricing", description: "Plans and ads — contact stays free" },
  ...
  de: {
    ...
    "/exchange": { label: "B2B Exchange", description: "Gesundheits-Marktplatz — Direktkontakt, keine Provision" },
  ...
  fr: {
    ...
    "/kontakt": { label: "Contact" },
    "/exchange": { label: "B2B Exchange", description: "Marketplace santé — contact direct, sans commission" },
  ...
  it: {
    ...
    "/exchange": { label: "B2B Exchange", description: "Marketplace sanitario — contatto diretto, senza commissione" },
  ...
  es: {
    ...
    "/exchange": { label: "B2B Exchange", description: "Marketplace sanitario — contacto directo, sin comisión" },
