...
const NAV: Record<string, NavStrings> = {
  en: {
    ...
    "/exchange/content": { label: "Expert briefs", description: "Legislation and clinical analyses" },
    "/exchange/dashboard": { label: "Company dashboard", description: "Listings, inquiries, subscription" },
    "/exchange/inquiries": { label: "Inquiries", description: "Contacts unlock on Pro" },
  ...
  de: {
    ...
    "/exchange": { label: "Exchange", description: "Gesundheits-Marktplatz — Direktkontakt, keine Provision" },
    "/exchange/catalog": { label: "Exchange-Katalog", description: "Filter EU / USA / Asien / Global" },
    "/exchange/onboard": { label: "Organisation registrieren", description: "B2B-Onboarding" },
    "/exchange/pricing": { label: "Exchange-Preise", description: "Tarife und Werbung — Kontakt bleibt frei" },
  ...
  fr: {
    ...
    "/kontakt": { label: "Contact" },
    "/exchange": { label: "Exchange", description: "Marketplace santé — contact direct, sans commission" },
    "/exchange/catalog": { label: "Catalogue Exchange", description: "Filtre UE / USA / Asie / Mondial" },
    "/exchange/onboard": { label: "Enregistrer l’organisation", description: "Onboarding B2B" },
    "/exchange/pricing": { label: "Tarifs Exchange", description: "Offres et publicité — contact gratuit" },
  ...
  it: {
    ...
    "/exchange": { label: "Exchange", description: "Marketplace sanitario — contatto diretto, senza commissione" },
  ...
  es: {
    ...
    "/exchange": { label: "Exchange", description: "Marketplace sanitario — contacto directo, sin comisión" },
