  ...
  cs: {
    ...
    audiences: [
      ...
      },
      {
        id: "physician",
        label: "Lékaři",
        description: "OrdiZapis napíše zápis z diktátu v telefonu. K tomu doporučení s DOI.",
      ...
      },
      {
        id: "student",
        label: "Studenti",
        description: "MeDiprep: mezery, testy B/C/F a simulace českých LF.",
        ctaPrimary: "MeDiprep",
    ...
    why: [
      ...
      },
      {
        ...
        description: "Testy biologie, chemie a fyziky podle požadavků českých LF. 1 test zdarma.",
      },
      {
    ...
    b2bTitle: "Inzerce na ViaLongeVita",
    b2bDescription:
      "Bannery a sponzorované články v magazínu. Lékařská zóna zůstává bez reklam. Tržiště výrobců je na /exchange.",
    b2bCta: "Ceník inzerce",
    todayFallback: "Dnes v magazínu ViaLongeVita",
    newsroom: "Redakce",
    readArticle: "Číst článek",
    headerSearchPlaceholder: "Aplikace, články, témata…",
    searching: "Hledám…",
    searchNoResults: "V magazínu nic nenašlo. Zkuste spánek, pohyb nebo GLP-1.",
  ...
  en: {
    ...
    audiences: [
      ...
      },
      {
        id: "physician",
        label: "Physicians",
        description: "OrdiZapis drafts the note from a phone dictation. Plus guidelines with DOI.",
      ...
      },
      {
        id: "student",
        label: "Students",
        description: "MeDiprep: B/C/F tests and Czech medical-school mocks.",
        ctaPrimary: "MeDiprep",
    ...
    why: [
      ...
      {
        title: "MeDiprep for admissions",
        description: "Biology, chemistry and physics tests for Czech medical faculties. One test free.",
      },
      {
    ...
    searching: "Searching…",
    searchNoResults: "Nothing in the magazine. Try sleep, movement or GLP-1.",
    ...
    footer: {
      ...
      audiences: [
        ...
        { label: "Students — MeDiprep", href: "/studenti" },
      ],
      proof: [
  ...
  de: {
    ...
    audiences: [
      ...
      },
      {
        ...
        description: "OrdiZapis schreibt die Notiz aus dem Diktat. Dazu Leitlinien mit DOI.",
      ...
      },
      {
        id: "student",
        label: "Studierende",
        description: "MeDiprep: B/C/F-Tests und Simulationen der tschechischen Fakultäten.",
        ctaPrimary: "MeDiprep",
    ...
    why: [
      ...
      {
        title: "MeDiprep für die Aufnahme",
        description: "Tests in Biologie, Chemie und Physik für tschechische Fakultäten. Ein Test kostenlos.",
      },
      {
    ...
    searching: "Suche…",
    searchNoResults: "Im Magazin nichts gefunden. Versuchen Sie Schlaf, Bewegung oder GLP-1.",
    ...
    footer: {
      ...
      audiences: [
        ...
        { label: "Studierende — MeDiprep", href: "/studenti" },
      ],
      proof: [
  ...
  fr: {
    ...
    audiences: [
      ...
      },
      {
        id: "physician",
        label: "Médecins",
        description: "OrdiZapis rédige la note à partir d’une dictée. Plus des recommandations avec DOI.",
      ...
      },
      {
        id: "student",
        label: "Étudiants",
        description: "MeDiprep : tests B/C/F et simulations des facultés tchèques.",
        ctaPrimary: "MeDiprep",
    ...
    why: [
      ...
      {
        title: "MeDiprep pour les concours",
        description: "Tests de biologie, chimie et physique pour les facultés tchèques. Un test offert.",
      },
      {
    ...
    searching: "Recherche…",
    searchNoResults: "Rien dans le magazine. Essayez sommeil, mouvement ou GLP-1.",
    ...
    footer: {
      ...
      audiences: [
        ...
        { label: "Étudiants — MeDiprep", href: "/studenti" },
      ],
      proof: [
        { label: `Articles · ${MAGAZINE.name}`, href: "/articles" },
...
COPY.pt = {
  ...
  audiences: [
    ...
    },
    {
      id: "physician",
      label: "Médicos",
      description: "O OrdiZapis redige a nota a partir do ditado no telemóvel. Mais normas com DOI.",
    ...
    },
    {
      id: "student",
      label: "Estudantes",
      description: "MeDiprep: testes B/C/F e simulações das faculdades checas.",
      ctaPrimary: "MeDiprep",
