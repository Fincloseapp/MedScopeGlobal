...
const COPY: Record<string, SubscribeCopy> = {
  cs: {
    ...
    bestForClinic: "Nejvýhodnější pro ordinaci — 390 Kč",
    ...
    priceNoteByApp: {
      medipacient: "14 dní zdarma, potom 249 Kč / měsíc",
      mediprep: "14 dní zdarma, potom 199 Kč / měsíc",
      ordizapis: "14 dní zdarma, potom 799 Kč / měsíc",
  ...
  en: {
    ...
    bestForClinic: "Best value for the clinic — 390 CZK",
    ...
    priceNoteByApp: {
      medipacient: "14 days free, then CZK 249 / month",
      mediprep: "14 days free, then CZK 199 / month",
      ordizapis: "14 days free, then CZK 799 / month",
  ...
  de: {
    ...
    bestForClinic: "Bestes Preis-Leistungs-Verhältnis für die Praxis — 390 CZK",
    ...
    priceNoteByApp: {
      medipacient: "14 Tage kostenlos, dann 249 CZK / Monat",
      mediprep: "14 Tage kostenlos, dann 199 CZK / Monat",
      ordizapis: "14 Tage kostenlos, dann 799 CZK / Monat",
  ...
  fr: {
    ...
    bestForClinic: "Meilleur rapport pour le cabinet — 390 CZK",
    ...
    priceNoteByApp: {
      medipacient: "14 jours gratuits, puis 249 CZK / mois",
      mediprep: "14 jours gratuits, puis 199 CZK / mois",
      ordizapis: "14 jours gratuits, puis 799 CZK / mois",
