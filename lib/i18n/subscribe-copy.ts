...
const COPY: Record<string, SubscribeCopy> = {
  cs: {
    ...
    parentsBodyBefore: "Tarif Student LF otevírá MeDiprep, AI tutor a kvízy. Nejdřív vyzkoušejte",
    selfTest: "self-test",
    ...
    plans: {
      ...
      student: {
        ...
        features: [
          ...
          "Modelové otázky, simulace fakult a studijní materiály",
          ...
          "149 Kč = Student LF (MeDiprep) — magazín otevírá tarif Redakce nebo vyšší plán",
        ],
      },
      dokumentace: {
        name: "OrdiZapis",
  ...
  en: {
    ...
    parentsBodyBefore: "The Medical student plan opens MeDiprep, the AI tutor and quizzes. First try the",
    selfTest: "self-test",
    ...
    comparisonLead:
      "Features by audience. Editorial: billed now. OrdiZapis and Physician: 14-day trial. Student: 1 free test, intro month, then 149 CZK / €10. OrdiZapis (390 CZK) is the documentation app; Physician (490 CZK) adds CME, DOI guidelines and clinical AI.",
    featureCol: "Feature",
    included: "Included",
    ...
    plans: {
      ...
      student: {
        ...
        features: [
          ...
          "Model questions, faculty mocks and study materials",
          "AI tutor and study materials",
          "Quizzes, games and model questions",
          "1 free test · intro month · then 149 CZK / €10 — cancel anytime",
          "149 CZK = Student LF (MeDiprep) — the magazine opens with Editorial or a higher plan",
        ],
      },
      dokumentace: {
        name: "OrdiZapis",
      ...
      physician: {
        ...
        features: [
          ...
          "Professional desk, DOI guidelines and rheumatology CME",
          "CME briefs and study summaries",
          "Clinical AI assistant",
          "Vs OrdiZapis 390 CZK: CME + DOI guidelines + priority alerts",
        ],
      },
    },
    comparisonRows: [
      ...
      "DOI guidelines (ESC outside rheumatology)",
      "MeDiprep — B/C/F tests",
  ...
  de: {
    ...
    parentsBodyBefore: "Der Tarif Medizinstudium öffnet MeDiprep, KI-Tutor und Quiz. Zuerst den",
    selfTest: "Selbsttest",
    ...
    comparisonLead:
      "Funktionen nach Zielgruppe. Redaktion: sofort. OrdiZapis und Arzt: 14 Tage Test. Medizinstudium: 1 Test frei, 6 €, danach 10 €. OrdiZapis (390 CZK) ist die Dokumentations-App; Arzt in der Praxis (490 CZK) ergänzt CME, DOI-Leitlinien und klinische KI.",
    featureCol: "Funktion",
    included: "Enthalten",
    ...
    plans: {
      ...
      student: {
        ...
        features: [
          ...
          "Modellfragen, Fakultätssimulationen und Lernmaterial",
          "KI-Tutor und Lernmaterial",
          "Quiz, Spiele und Modellfragen",
          "1 Test frei · Einstiegsmonat 6 € · danach 10 € — jederzeit kündbar",
          "10 € = Student LF (MeDiprep) — das Magazin öffnet das Redaktionsabo oder ein höherer Tarif",
        ],
      },
      dokumentace: {
        name: "OrdiZapis",
      ...
      physician: {
        ...
        features: [
          ...
          "Fachredaktion, DOI-Leitlinien und CME Rheumatologie",
          "CME-Überblicke und Studienkurzfassungen",
          "Klinischer KI-Assistent",
          "Gegenüber OrdiZapis 390 CZK: CME + DOI-Leitlinien + Prioritätsalarme",
        ],
      },
    },
    comparisonRows: [
      ...
      "DOI-Leitlinien (ESC außerhalb der Rheumatologie)",
      "MeDiprep — B/C/F-Tests",
  ...
  fr: {
    ...
    parentsBodyBefore: "La formule Étudiant en médecine ouvre MeDiprep, le tuteur IA et les quiz. Essayez d’abord le",
    selfTest: "auto-test",
    ...
    comparisonLead:
      "Fonctions par public. Rédaction : paiement immédiat. OrdiZapis et Médecin : 14 jours d’essai. Étudiant : 1 test offert, 6 €, puis 10 €. OrdiZapis (390 CZK) est l’appli de notes ; Médecin en exercice (490 CZK) ajoute FMC, recommandations DOI et IA clinique.",
    featureCol: "Fonction",
    included: "Inclus",
    ...
    plans: {
      ...
      student: {
        ...
        features: [
          ...
          "Questions types, simulations de facultés et supports d’étude",
          "Tuteur IA et supports d’étude",
          "Quiz, jeux et questions types",
          "1 test offert · premier mois 6 € · puis 10 € — résiliation à tout moment",
          "10 € = Student LF (MeDiprep) — le magazine s’ouvre avec la Rédaction ou une formule supérieure",
        ],
      },
      dokumentace: {
        name: "OrdiZapis",
      ...
      physician: {
        ...
        features: [
          ...
          "Bureau professionnel, recommandations DOI et FMC rhumatologie",
          "Brèves FMC et synthèses d’études",
          "Assistant IA clinique",
          "Vs OrdiZapis 390 CZK : FMC + recommandations DOI + alertes prioritaires",
        ],
      },
    },
    comparisonRows: [
      ...
      "Recommandations DOI (ESC hors rhumatologie)",
      "MeDiprep — tests B/C/F",
