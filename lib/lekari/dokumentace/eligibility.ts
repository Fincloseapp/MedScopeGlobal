...
export async function getDokumentaceEligibility(
  ...
  if (!userId) {
    return {
      ...
      facilities: [],
      message:
        "Pro stažení a používání aplikace MedScope Dokumentace se přihlaste ověřeným lékařským účtem.",
    };
  }
  ...
  if (!eligible) {
    return {
      ...
      facilities,
      message:
        "Stažení a plné používání Dokumentace je jen pro ověřené lékaře (nebo účet zdravotnického zařízení). Dokončete ověření v Lékařské zóně.",
    };
  }
