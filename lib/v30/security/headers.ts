...
export function permissionsPolicyForPath(pathname?: string): string {
  ...
  if (pathname.startsWith("/app/mediktor") || pathname.startsWith("/app/dokumentace") || pathname.startsWith("/mediktor") || pathname.startsWith("/lekari/mediktor") || pathname.startsWith("/lekari/dokumentace")) {
