...
export const DEMO_LISTINGS: ExchangeListing[] = [
  {
    ...
    organization: {
      ...
      verified: true,
      contactEmail: DEMO_ORGANIZATIONS[0].contactEmail,
      contactPhone: DEMO_ORGANIZATIONS[0].contactPhone,
  ...
  },
  {
    ...
    organization: {
      ...
      verified: true,
      contactEmail: DEMO_ORGANIZATIONS[1].contactEmail,
  ...
  },
  {
    ...
    organization: {
      ...
      verified: true,
      contactEmail: DEMO_ORGANIZATIONS[2].contactEmail,
    },
