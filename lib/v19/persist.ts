  ...
  const { data, error } = await admin
    ...
    .insert({
      ...
      quiz_json: {
        ...
        nzipGlossaryTerms: article.nzipGlossaryTerms ?? null,
        nzipEducationalLinks: article.nzipEducationalLinks ?? null,
        nzipRegistryRefs: article.nzipRegistryRefs ?? null,
...
export function mapV19RowToArticle(
  ...
  const payload: V19ArticlePayload = {
    ...
    nzipGlossaryTerms: (meta.nzipGlossaryTerms as string[]) ?? undefined,
    nzipEducationalLinks: (meta.nzipEducationalLinks as V19ArticlePayload["nzipEducationalLinks"]) ?? undefined,
    nzipRegistryRefs: (meta.nzipRegistryRefs as string[]) ?? undefined,
