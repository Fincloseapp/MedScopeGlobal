...
export const PAYOUT_CHANNELS: PayoutChannel[] = [
  {
    ...
    payoutTo: "Firemní účet napojený ve Stripe (MedScopeGlobal / účet, který tam zadáte).",
  ...
  },
  {
    ...
    payoutTo: "Firemní účet MedScopeGlobal — provozuje Al Synaptica Research Institute s.r.o. Žádný affiliate účet.",
