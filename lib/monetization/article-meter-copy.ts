...
const PACKS: Record<string, Pack> = {
  ...
  de: {
    remainingTpl: "Noch {pct} % des Artikels",
    youWillRead: "Sie lesen noch",
    continueReading: "Weiterlesen",
    leftoverFallback: "den Rest der Argumente, die Praxispunkte und die Quellen",
    yearSecondary: "oder das Jahresabo",
  },
  fr: {
    remainingTpl: "Il reste {pct} % de l’article",
    youWillRead: "Vous lirez encore",
  ...
  it: {
    remainingTpl: "Manca ancora il {pct} % dell’articolo",
    youWillRead: "Leggerete ancora",
  ...
  es: {
    remainingTpl: "Queda el {pct} % del artículo",
    youWillRead: "Todavía leerá",
  ...
  en: {
    remainingTpl: "{pct}% of the article left",
    youWillRead: "You will still read",
