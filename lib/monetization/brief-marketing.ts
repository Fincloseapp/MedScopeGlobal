...
const CHROME: Record<string, BriefChrome> = {
  ...
  ja: {
    ...
    readStory: "記事を読む",
    heroLabel: "今週の主文",
    moreThisWeek: "今号のほかの記事",
    disclosure:
      "As an Amazon Associate I earn from qualifying purchases. Product links are optional — the brief stays free.",
    welcomeExpect: "毎週、睡眠・運動・長寿について3本。無料。購読の強制はありません。",
    welcomeKicker: "ようこそ",
    preheader: "今週、静かに読める3本。",
    openMagazine: "雑誌を開く",
    brandLine: "どの年齢でも、よりよく、より長く。",
  },
  ko: {
    edition: "주간 브리프",
    readStory: "기사 읽기",
    heroLabel: "이번 주 본문",
    moreThisWeek: "이번 호의 다른 글",
    disclosure:
      "As an Amazon Associate I earn from qualifying purchases. Product links are optional — the brief stays free.",
    welcomeExpect: "매주 수면, 운동, 장수에 관한 글 세 편. 무료. 구독 강요 없음.",
    welcomeKicker: "환영합니다",
    preheader: "이번 주 차분히 읽을 세 편.",
    openMagazine: "매거진 열기",
    brandLine: "모든 나이에서 더 잘, 더 오래.",
  },
  "zh-CN": {
    edition: "每周简报",
    readStory: "阅读文章",
    ...
    disclosure:
      "As an Amazon Associate I earn from qualifying purchases. Product links are optional — the brief stays free.",
    welcomeExpect: "每周三篇关于睡眠、运动与长寿的文章。免费。没有订阅压力。",
    welcomeKicker: "欢迎",
    preheader: "本周值得安静阅读的三篇。",
    openMagazine: "打开杂志",
    brandLine: "在每个年龄都活得更好、更久。",
  },
  en: {
