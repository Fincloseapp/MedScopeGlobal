...
export const BAD_UNSPLASH_IDS = [
  ...
  "photo-1612349317150-e413f6a5b16d", // US clinic branding / stock portrait
  "photo-1505751172879-fb9847c0e0c0", // non-European hands
  "photo-1505751172876-fa1923c5c528", // stock portrait (removed from site)
  "photo-1505751172876-fbf96182a2d8", // stock portrait (newsletter hero)
  ...
  "photo-1559757148-5c350d0d3c56", // brain / anatomy prop
  "photo-1559757175-0eb30cd8c063", // anatomical model
];
