...
const TOPIC_RULES = [
  ...
  { re: /anatom|orgán|srdce|kost|nemoc/i, type: "object", module: "medicina", category: "nemoci" },
  { re: /spánk|spanek|unaven/i, type: "environment", module: "sleep", category: "zivotni-styl" },
  { re: /výživ|vyziv|jíd|talíř|talir|bílkovin/i, type: "environment", module: "food", category: "zivotni-styl" },
  { re: /stres|dechov|imunit/i, type: "environment", module: "forest", category: "zivotni-styl" },
  { re: /hydrat|pitn|vod[ae]/i, type: "environment", module: "water", category: "zivotni-styl" },
