...
const CURATED_PHOTOS = {
  ...
  verejnost: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=1200&h=675&fit=crop&q=85&auto=format&fm=webp",
  interview:
    "https://images.unsplash.com/photo-1478737270239-2f02e77f67c9?w=1200&h=675&fit=crop&q=85&auto=format&fm=webp",
  food: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=1200&h=675&fit=crop&q=85&auto=format&fm=webp",
  sleep: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=1200&h=675&fit=crop&q=85&auto=format&fm=webp",
  forest: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1200&h=675&fit=crop&q=85&auto=format&fm=webp",
  water: "https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=1200&h=675&fit=crop&q=85&auto=format&fm=webp",
};

const HANDS_EMPHASIS = [
  "Photorealistic editorial medical photography.",
  "European clinic, kitchen, park, or Czech university setting.",
  "Topic-matching still life: food, water, sleep, movement equipment, stethoscope, microphone — no identifiable faces.",
  "No anatomical brain models, no cadavers, no violence, no doctor portraits.",
  "Educational magazine quality, diplomatically neutral, trustworthy.",
