...
export const CATEGORY_TEMPLATES = {
  ...
  nemoci: {
    ...
    imageType: "illustration",
    promptExtra:
      "Clinical equipment or gloved hands with a stethoscope, Czech clinic, educational magazine style. No anatomical brain models, no cadavers, no identifiable clinicians or patients.",
  },
  prevence: {
    module: "verejnost",
  ...
  "zivotni-styl": {
    ...
    imageType: "environment",
    promptExtra:
      "Healthy lifestyle editorial still life — nutrition plate, water glass, made bed, walking shoes or park path, modern Czech setting, bright natural light. No portraits, no brain models.",
  },
  dlouhovekost: {
    module: "verejnost",
    imageType: "illustration",
    promptExtra:
      "Longevity and healthspan editorial — active aging, sleep, movement, nutrition symbols, European wellness context, optimistic science-backed mood, no stock faces.",
  },
  medical: {
    module: "medicina",
    imageType: "illustration",
...
const TOPIC_ALIASES = {
  ...
  dlouhovekost: ["dlouhověkost", "dlouhovekost", "healthspan", "longevity", "stárnutí", "starnuti", "biologický věk"],
...
export function resolveCategoryKey(input) {
  ...
  const pillar = String(meta.content_pillar ?? "").toLowerCase().trim();
  if (pillar === "dlouhovekost" && CATEGORY_TEMPLATES.dlouhovekost) return "dlouhovekost";
