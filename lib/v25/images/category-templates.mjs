...
export const CATEGORY_TEMPLATES = {
  ...
  medical: {
    ...
    imageType: "illustration",
    promptExtra:
      "European clinical setting, white-skinned gloved hands only, professional medical editorial, trustworthy academic tone, no identifiable patients.",
  },
  medicina: {
    module: "medicina",
    imageType: "illustration",
    promptExtra:
      "European hospital or clinic, white-skinned European hands in white clinical gloves, neutral professional medical editorial.",
  },
};
