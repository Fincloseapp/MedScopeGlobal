...
const STYLE_GUIDE = {
  ...
  avoid: "race, ethnicity, stereotypes, US-specific settings, political symbols, identifiable patients",
...
export function buildSafePrompt({ title, topics, imageType, section }) {
  ...
  return [
    ...
    "no race or ethnicity descriptors, no stereotypes, no US-specific settings.",
