...
const ODBORNA_PATHS = ["/odborne", "/odborne/nejnovejsi", "/odborne/briefy", "/odborne/kategorie"];

const API_PATHS = ["/api/v19/health", "/api/v24/health", "/api/v24/monitoring", "/api/v25/health"];
...
const isMain = process.argv[1]?.includes("run-suite");
if (isMain) {
