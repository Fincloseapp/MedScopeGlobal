...
export const SEEDS = [
  { seed: "Zdravý spánek před začátkem školního roku", angle: "režim, světlo a obrazovky u dětí i dospělých" },
  ...
  { seed: "Hydratace a energie v pozdním létě", angle: "mýty o pitném režimu" },
  { seed: "Bílkoviny u každého jídla", angle: "síla, sytost a české recepty bez extrémů" },
  { seed: "Chůze jako lék, který má téměř každý po ruce", angle: "tempo, VO2 max a klouby" },
