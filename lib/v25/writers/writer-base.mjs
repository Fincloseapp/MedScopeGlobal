...
export async function generateJsonFromLlm({ system, user, maxTokens = 6000, temperature = 0.4 }) {
  loadEnvLocal();
...
Vrať JSON: { "title": string, "excerpt": string (2–3 věty teaser), "bodyHtml": string (HTML s <p>, <h2>, <ul> nebo <h3>, včetně <h2>Zdroje</h2>), "keywords": string[], "metaDescription": string }`;
  ...
  const parsed = await generateJsonFromLlm({ system, user, maxTokens: 6000, temperature });
