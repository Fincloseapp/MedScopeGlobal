...
import { pickPersonaForArticle, pickAlternatePersona, getPersonaById } from "../../v26/personas.mjs";
import {
...
export function fallbackArticle({
  ...
  return {
    title,
    excerpt: `${seed} — ${angle}. Srozumitelně a bez zbytečného strašení, od ${persona?.displayName ?? writerName}.`,
    bodyHtml,
...
Piš jako ${persona.displayName}, ne jako generická AI. Vlastní redakční hlas — inspirace Healthline/WebMD, ale česky.
