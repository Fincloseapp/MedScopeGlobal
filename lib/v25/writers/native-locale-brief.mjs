...
const LOCAL_HINT = {
  ...
  "en-UK": "GP, NHS 111/999, MHRA/NICE. British English.",
};
...
- Témata této redakce (nativně, ne jako překlad z češtiny): slim / metabolické zdraví a udržitelné hubnutí; zdraví a prevence; dlouhověkost / healthspan; zdravý životní styl; biohacking jen s evidencí (wearables, spánek, bez hype).
- Další témata volte podle geopolitiky této země — to, co zajímá místního čtenáře, ne české pojišťovny, přijímačky nebo SÚKL jako místní radu.
- Články vznikají nativně pro tuto mutaci. Cizí text přebírej jen výjimečně; pak ho adaptuj, označ zahraniční redakci MedScopeGlobal a přidej místní kontext.
