...
export const BROKEN_UNSPLASH_PHOTO_IDS = [
  ...
  "photo-1559757175-0eb30cd8c063", // brain-on-stick — hard banned
  "photo-1559757148-5c350d0d3c56",
  "photo-1576091160399-112ba8d25d1d", // doctor-on-phone stock
...
const SAFE_CLINICAL = "/assets/covers/clinical-3.webp";

export const KEYWORD_IMAGES = {
  anatomy: SAFE_CLINICAL,
  orientation: SAFE_CLINICAL,
  skeleton: SAFE_CLINICAL,
  heart: SAFE_CLINICAL,
  blood: SAFE_CLINICAL,
  circulation: SAFE_CLINICAL,
