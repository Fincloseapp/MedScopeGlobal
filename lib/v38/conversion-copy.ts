  ...
  nav_cta: [
    {
      ...
      body: "Aplikace MeDipacient, MeDiprep a OrdiZapis plus VIP články. Redakce od 25 Kč. OrdiZapis 14 dní zdarma.",
      ctaLabel: "Zobrazit tarify",
      ctaHref: "/predplatne",
    },
  ],
  nav_strip: [
    {
      ...
      body: "MeDipacient, MeDiprep a OrdiZapis — zkušební dashboard hned. Redakce od 25 Kč. OrdiZapis 14 dní zdarma.",
      ctaLabel: "Stáhnout aplikace",
      ctaHref: "/aplikace",
      hint: "OrdiZapis 14 dní",
    },
    {
      slot: "nav_strip",
  ...
  article_inline: [
    {
      ...
      body: "Tarif Redakce od 25 Kč měsíčně nebo 250 Kč za rok. Tipy v článcích zůstávají dobrovolné.",
      ctaLabel: "Otevřít tarif Redakce",
      ctaHref: "/predplatne#public",
    },
  ],
  video_overlay: [
    {
...
const I18N_STATIC: Record<string, Partial<Record<ConversionSlot, ConversionCopy>>> = {
  en: {
    nav_cta: {
      ...
      eyebrow: "For you",
      headline: "MedScope Premium",
      body: "MeDipacient, MediFlow and OrdiZapis plus VIP articles. Editorial from 25 CZK. OrdiZapis 14 days free.",
      ctaLabel: "See plans",
      ctaHref: "/predplatne",
    },
    nav_strip: {
      ...
      body: "MeDipacient, MediFlow and OrdiZapis — open the trial dashboard now. Editorial billed now. OrdiZapis 14 days free.",
      ctaLabel: "Get the apps",
      ctaHref: "/aplikace",
      hint: "OrdiZapis 14 days",
    },
  },
  de: {
    nav_cta: {
      ...
      eyebrow: "Für Sie",
      headline: "MedScope Premium",
      body: "MeDipacient, MediFlow und OrdiZapis plus VIP-Artikel. Redaktion ab 1 €. OrdiZapis 14 Tage kostenlos.",
      ctaLabel: "Tarife ansehen",
      ctaHref: "/predplatne",
    },
    nav_strip: {
      slot: "nav_strip",
      ...
      body: "MeDipacient, MediFlow und OrdiZapis — Testdashboard sofort. Redaktion sofort. OrdiZapis 14 Tage kostenlos.",
      ctaLabel: "Apps laden",
      ctaHref: "/aplikace",
      hint: "OrdiZapis 14 Tage",
    },
  },
  fr: {
    nav_cta: {
      ...
      eyebrow: "Pour vous",
      headline: "MedScope Premium",
      body: "MeDipacient, MediFlow et OrdiZapis plus articles VIP. Rédaction dès 1 €. OrdiZapis 14 jours gratuits.",
    ...
    nav_strip: {
      ...
      body: "MeDipacient, MediFlow et OrdiZapis — tableau d’essai immédiat. Rédaction tout de suite. OrdiZapis 14 jours gratuits.",
      ctaLabel: "Télécharger les applis",
      ctaHref: "/aplikace",
      hint: "OrdiZapis 14 jours",
    },
  },
};
    ...
    return withLocalPrices(
      {
        ...
        headline: "Weiterlesen?",
        body: `Die ersten Absätze bleiben offen. Den ganzen Text öffnet das Redaktionsabo — ${price} im Monat oder das Jahresabo. Kein VIP-Zwang.`,
    ...
    return withLocalPrices(
      {
        ...
        headline: "Lire la suite ?",
        body: `Les premiers paragraphes restent ouverts. Le texte entier s’ouvre avec l’abonnement Rédaction — ${price} par mois ou l’annuel. Ce n’est pas un club VIP.`,
    ...
    return withLocalPrices(
      {
        ...
        headline: "Read on?",
        body: `The opening stays readable. The rest opens with Editorial — ${price} a month or the yearly plan. This is not a VIP club.`,
        ctaLabel: "Read on",
        ctaHref: "/predplatne#public",
  ...
  return withLocalPrices(
    {
      ...
      headline: "Chcete číst dál?",
      body: `Úvodní odstavce zůstávají čitelné. Zbytek textu otevírá tarif Redakce — ${price} měsíčně nebo roční plán. Toto není VIP členství.`,
      ctaLabel: "Číst dál",
      ctaHref: "/predplatne#public",
      hint: "Náhled níže — zbytek po aktivaci",
    },
