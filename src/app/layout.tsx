...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="cs"><body><JsonLd data={organizationJsonLd()} /><Header />{children}<Footer /><Suspense fallback={null}><AnalyticsProvider /></Suspense></body></html>; }
